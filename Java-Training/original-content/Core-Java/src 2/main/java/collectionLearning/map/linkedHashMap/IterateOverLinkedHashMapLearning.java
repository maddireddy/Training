package collectionLearning.map.linkedHashMap;

import java.util.Iterator;
import java.util.LinkedHashMap;
import java.util.Map;

public class IterateOverLinkedHashMapLearning {
    public static void main(String[] args) {
        ...
        System.out.println("\n=== Iterating over the LinkedHashMap's entrySet using Java 17x forEach and lambda ===");
        userCityMapping.forEach((key, value) -> System.out.println(STR."\{key} => \{value}"));
